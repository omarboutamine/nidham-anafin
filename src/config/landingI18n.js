...
const content = {
  ar: {
    ...
    dashboard: {
      ...
      structureAnalysisHint: 'Analyse de la structure financière',
      logout: 'تسجيل الخروج',
    },
    analysis: {
      kicker: 'تحليل',
      title: 'تحليل الهيكل المالي',
      lead: 'قراءة هيكل الميزانية للسنة المختارة: توزيع الأصول والخصوم، السيولة، FRNG وBFR.',
      ...
      frng: 'رأس المال العامل الصافي الإجمالي (FRNG)',
  ...
  fr: {
    ...
    dashboard: {
      ...
      homeHint:
        'Choisissez une analyse dans le menu latéral, ou ouvrez le bilan et le TCR depuis l’en-tête.',
      ...
      structureAnalysisHint: 'تحليل الهيكل المالي',
      logout: 'Déconnexion',
    },
    analysis: {
      kicker: 'Analyse',
      ...
      lead:
        'Lecture de la structure du bilan pour l’exercice choisi : répartition Actif/Passif, liquidité, FRNG et BFR.',
      ...
      frng: 'Fonds de roulement net global (FRNG)',
